  ...
  <main class="container">
    <section class="row my-5 py-md-5 gap-md-2 mx-0 p-3 border border-1 rounded-3">
      ...
      <div class="col-xl-4 col-md-10 mx-md-auto my-md-5">
        ...
        <form class="d-flex flex-column gap-3" action="includes/login.inc.php" method="POST">
          <div class="mb-3">
            <label for="nim" class="form-label">Student ID</label>
          ...
          <button type='submit' name='submit' class='btn btn-primary px-5 mx-auto rounded-3'>Login</button>
        </form>
      </div>
    </section>
  </main>
